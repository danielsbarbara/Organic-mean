    ...
    return(
        <div className="flex gap-4 w-full justify-center">
            ...
            <div key={Math.random()} className="border-t-[1px] border-l-[1px] border-white w-4 h-4 absolute -translate-x-1 -translate-y-1 md:h-7 md:w-7"></div>
                {el}
            <div key={Math.random()} className="border-b-[1px] border-r-[1px] border-white w-4 h-4 absolute translate-x-9 -translate-y-3 md:translate-x-[4.70rem] md:-translate-y-6 md:w-7 md:h-7"></div>
            </div>
            </>
            )}
        </div>
