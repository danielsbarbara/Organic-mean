            ...
            {imageArray.map((el, i) =>
                <>
                    <div key={i} className="w-16 md:w-32">
                        ...
                        {el}
                        <div key={Math.random()} className="border-b-[1px] border-r-[1px] border-white w-4 h-4 absolute translate-x-9 -translate-y-3 md:translate-x-[5.5rem] md:-translate-y-6 md:w-7 md:h-7"></div>
                    </div>
                </>
            )}
        </div>
